...
方便快捷的开始新项目的开发（适用项目：OA、ERP、CRM、CMS后台等），不用自己
整个是基于React的技术栈就不多说了，优点就是react的优点，界面UI基于 [antd](http://ant.design/)
...
界面如下
![react-admin界面](http://7xqg7e.com1.z0.glb.clouddn.com/ui.PNG)
